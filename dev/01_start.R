...
golem::fill_desc(
  pkg_name = "connectAnalytics", # The Name of the package containing the App 
  pkg_title = "Rstudio Connect Analytics", # The Title of the package containing the App 
  pkg_description = "An R package containing a shiny app to display analytics for RStudio Connect", # The Description of the package containing the App 
  author_first_name = "Tyler", # Your First Name
  author_last_name = "Bradley",  # Your Last Name
  author_email = "tyler.bradley@phila.gov",      # Your Email
  repo_url = "https://github.com/tbradley1013/connectAnalytics" # The (optional) URL of the GitHub Repo
)     
